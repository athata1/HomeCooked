...
class UserAdmin(admin.ModelAdmin):
    list_display = ('user_id', 'user_uname', 'user_pass', 'user_email', 'user_address', 'user_bio')
    list_display_links = ('user_id', 'user_uname')
    list_filter = ('user_id', 'user_uname', 'user_email')
    search_fields = ('user_id', 'user_uname', 'user_email')
